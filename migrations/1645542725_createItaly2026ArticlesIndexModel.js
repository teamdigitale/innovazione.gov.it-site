...
module.exports = async (client) => {
  ...
  const title = await client.fields.create(italy2026ArticlesIndex.id, {
    label: "Titolo",
    apiKey: "title",
    fieldType: "string",
    validators: {
  ...
  const slug = await client.fields.create(italy2026ArticlesIndex.id, {
    label: "Slug",
    apiKey: "slug",
    fieldType: "slug",
    validators: {
