...
module.exports = async (client) => {
  ...
  const subtitleField = await client.fields.create(videoModel.id, {
    label: 'Sottotitolo',
    apiKey: 'subtitle',
    fieldType: 'string',
    position: 2,
  ...
  const slugField = await client.fields.create(videoModel.id, {
    label: 'Slug',
    apiKey: 'slug',
    fieldType: 'slug',
    position: 3,
  ...
  const videoField = await client.fields.create(videoModel.id, {
    label: 'video',
    apiKey: 'video',
    fieldType: 'video',
  ...
  const transcriptionField = await client.fields.create(videoModel.id, {
    label: 'Trascrizione',
  ...
  const departmentSubpageModel = await client.itemType.find('department_subpage');
  ...
  const attachmentsField = await client.fields.create(videoModel.id, {
    label: 'Allegati',
    apiKey: 'attachments',
    fieldType: 'links',
    fieldset: contentFieldset.id,
  ...
  const linksField = await client.fields.create(videoModel.id, {
    label: 'Collegamenti',
    apiKey: 'links',
    fieldType: 'links',
    fieldset: contentFieldset.id,
  ...
  const relatedItemsField = await client.fields.create(videoModel.id, {
  ...
  const ownersField = await client.fields.create(videoModel.id, {
  ...
  const targetsField = await client.fields.create(videoModel.id, {
    label: 'Targets',
    apiKey: 'targets',
    fieldType: 'links',
    fieldset: ontologyFieldset.id,
  ...
  const dateField = await client.fields.create(videoModel.id, {
  ...
  const videoLengthField = await client.fields.create(videoModel.id, {
    label: 'Durata video',
    apiKey: 'time',
    fieldType: 'integer',
    fieldset: metadataFieldset.id,
  ...
  const seoMetatagsField = await client.fields.create(videoModel.id, {
    label: 'SEO',
    apiKey: 'seo',
    fieldType: 'seo',
